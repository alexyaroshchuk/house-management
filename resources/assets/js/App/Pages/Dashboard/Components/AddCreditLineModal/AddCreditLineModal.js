...
import './AddCreditLineModal.scss';
...
const AddCreditLineModal = (props) => {
    const {
        isShowModal,
        isModalLoader,
        closeModal,
        ...
        if (success) {
            return (
                <div className="success">
                    <p className="info">
                        Credit line has been created successfully
                    </p>
                </div>
            );
        }
    ...
    return (
        <Modal
            ...
            visible={isShowModal}
            onCancel={closeModal}
            className="add-credit-line-modal credit-line-modal"
...
export default AddCreditLineModal;
